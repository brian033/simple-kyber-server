...
var Price = /*#__PURE__*/function (_Fraction) {
  ...
  Price.fromReserves = function fromReserves(inputReserves, outputReserves) {
    !(inputReserves.length === outputReserves.length) ? process.env.NODE_ENV !== "production" ? invariant(false, 'RESERVE') : invariant(false) : void 0;
    var prices = [];
...
export { ChainId, Currency, CurrencyAmount, DMMFactory, DMMPool, ERC20, ETHER, Fetcher, Fraction, InsufficientInputAmountError, InsufficientReservesError, MINIMUM_LIQUIDITY, ONE, PRECISION, Pair, Percent, Price, Rounding, Route, Router, SOLIDITY_TYPE_MAXIMA, SolidityType, TEN, THREE, TWO, Token, TokenAmount, Trade, TradeType, WETH, ZERO, _100, computePriceImpact, currencyEquals, inputOutputComparator, parseBigintIsh, sortedInsert, sqrt, tradeComparator, validateAndParseAddress, validateSolidityTypeInstance };
